...
function getUsedCars(make, model, yearMin, yearMax, callback){
  ...
  var options = {
    url: sprintf('https://api.tmsandbox.co.nz/v1/Search/Motors/Used.json?make=%s&model=%s&year_max=%d&year_min=%d&rows=500&sort_order=ExpiryAsc', make, model, yearMax, yearMin),
    headers: {
